...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, BEEP_Pin|LORA_M0_Pin|LORA_M1_Pin|OLED_CS_Pin
  ...
  /*Configure GPIO pins : BEEP_Pin LORA_M0_Pin LORA_M1_Pin OLED_CS_Pin
                           LED_RED_Pin */
  GPIO_InitStruct.Pin = BEEP_Pin|LORA_M0_Pin|LORA_M1_Pin|OLED_CS_Pin
                          |LED_RED_Pin;
  ...
  /*Configure GPIO pins : OLED_DC_Pin OLED_RES_Pin LED_GREEN_Pin */
  ...
  /*Configure GPIO pins : CCD_SI_Pin CCD_CLK_Pin */
